...
public final class MachinesLibrary {
	...
	public static TuringMachine EqualBinaryWords() {
		...
		newTM.addTransition("q1", '0', "q9", 'x', true);
		...
		newTM.addTransition("q8", '3', "q10", 'x', true);
		
		newTM.addTransition("q9", '1', "q5", 'x', true);
		newTM.addTransition("q9", '2', "q6", 'x', true);

		newTM.addTransition("q10", '1', "q4", 'x', true);
		newTM.addTransition("q10", '2', "q4", 'x', true);
		newTM.addTransition("q10", '3', "q4", 'x', true);
		newTM.addTransition("q10", '4', "q4", 'x', true);
		newTM.addTransition("q10", '5', "q4", 'x', true);
		newTM.addTransition("q10", '6', "q4", 'x', true);
		newTM.addTransition("q10", '7', "q4", 'x', true);
		return newTM;
	}
}